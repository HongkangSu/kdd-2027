...
trained and evaluated separately on each network under a fixed CAV
penetration rate and a deterministic incident schedule, so transfer across
networks, demands, and human behaviors
