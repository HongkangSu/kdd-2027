...
\paragraph{Decoder and reconstruction loss.}  The decoder maps each segment
latent to the dynamic attributes with a SiLU block and linear channel heads:
\begin{equation}
\begin{array}{rcl}
...
\end{array}
\end{equation}
It is trained jointly with the dynamics model with a reconstruction loss on
observed traffic fields:
\begin{equation}
\begin{array}{rcl}
