...
\begin{figure*}[t]
  ...
  \caption{Training curves over real SUMO environment steps on the three urban networks.}
...
\begin{figure}[t]
  ...
  \caption{Total training time across networks ordered by road-segment count, with the 24-segment synthetic Toy network included only as a pilot point.}
...
\begin{figure*}[!t]
  ...
  \caption{Training curves of UrbanDreamer and Actor-Critic (No World Model) over real SUMO environment steps; higher \(-T_{\mathrm{all}}\) is better.}
