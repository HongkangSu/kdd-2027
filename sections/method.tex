...
\begin{figure*}[t]
  ...
  \caption{Overview of UrbanDreamer. Simulator episodes populate a replay buffer that trains the flow-matching world model and the HDV response predictor; in imagined rollouts, the actor samples routes, a vehicle wrapper advances each CAV under the decoded travel times, and per-vehicle and global critics update the policy.}
