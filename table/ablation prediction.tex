\begin{table}[t]
  \centering
  \caption{Transition ablation: 8-step autoregressive rollout error of frozen world-model checkpoints, as MAE of normalized speed and capacity-normalized vehicle count. Lower is better.}
