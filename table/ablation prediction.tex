\begin{table}[t]
  \centering
  \caption{8-step autoregressive rollout MAE of normalized speed and capacity-normalized vehicle count for frozen world-model checkpoints. Lower is better.}
